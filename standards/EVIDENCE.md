...
- This file's structure is informed by the user's [`CLAUDE.md`](../research/CLAUDE.md) research rules (facts only, no fabrication, sources mandatory).
- The auto-rejection trigger list is derived from observed failure modes in `~/.claude.old/standards/EVIDENCE.md` (see [`../../SYSTEM.md`](../research/sources/SYSTEM.md) for the predecessor analysis).
