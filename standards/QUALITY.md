...
- The 85/100 threshold is calibrated from observed pass histories in `~/.claude.old/cdocs/` (see analysis in [`../../SYSTEM.md`](../research/sources/SYSTEM.md), section on "Notable design decisions"); the dogfooding evidence showed 85 separates "ship-ready" from "needs another loop" cleanly.
