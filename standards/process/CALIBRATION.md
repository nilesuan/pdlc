...
The 0.75 default is a chosen starting point for this system; it has no upstream named source. [UNVERIFIED — flagged per [`../../../CLAUDE.md`](../../research/CLAUDE.md) §4.] *Why flag it:* defaults are silent assumptions that compound; tagging makes the choice auditable.
